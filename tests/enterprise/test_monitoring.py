...
class TestMetricsCollector:
    ...
    def test_metrics_collector_creation(self, mock_config):
        ...
        with patch(
            "networkx_mcp.enterprise.monitoring.get_config", return_value=mock_config
        ):
    ...
    def test_system_metrics_without_psutil(self, mock_config):
        ...
        with patch(
            ...
            with patch(
                "networkx_mcp.enterprise.monitoring.psutil", side_effect=ImportError
            ):
...
class TestAuditLogger:
    ...
    def test_request_context_management(self, mock_config):
        ...
        with patch(
            ...
            logger.set_request_context(
                "req-123", "user456", "192.168.1.1", "test-client"
            )
    ...
    def test_authentication_logging(self, mock_config):
        ...
        with patch(
            ...
            logger.log_authentication(
                "user123", "api_key", True, "192.168.1.1", {"api_key_hash": "abc123"}
            )
    ...
    def test_authorization_logging(self, mock_config):
        ...
        with patch(
            ...
            logger.log_authorization(
                "user123", "admin_access", "system", False, "insufficient_privileges"
            )
    ...
    def test_operation_logging(self, mock_config):
        ...
        with patch(
            ...
            logger.log_operation(
                "add_nodes", "my_graph", False, 75.2, {"error": "validation_failed"}
            )
    ...
    def test_security_event_logging(self, mock_config):
        ...
        with patch(
            ...
            logger.log_security_event(
                "rate_limit_exceeded", "high", {"limit": "per_minute"}
            )
    ...
    def test_log_format_configuration(self):
        ...
        with patch(
            "networkx_mcp.enterprise.monitoring.get_config", return_value=config
        ):
            logger = AuditLogger()
