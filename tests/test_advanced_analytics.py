...
from networkx_mcp.advanced import (
    ...
    BipartiteAnalysis, DirectedAnalysis, SpecializedAlgorithms,
    MLIntegration, RobustnessAnalysis
)
...
class TestSpecializedAlgorithms:
    ...
    def test_graph_coloring(self):
        ...
        assert result["is_valid_coloring"] == True
...
class TestPerformance:
    ...
    def test_large_graph_community_detection(self):
        ...
        assert result["num_communities"] > 0
        print(f"Community detection on 10k nodes: {elapsed:.2f}s")
    ...
    def test_embedding_scalability(self):
        ...
        for n in sizes:
            ...
            print(f"Embeddings for {n} nodes: {elapsed:.2f}s")
