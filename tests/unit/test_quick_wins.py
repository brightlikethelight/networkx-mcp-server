...
class TestFormatters:
    ...
    def test_format_graph_info(self):
        ...
        try:
            ...
            info = {"graph_id": "test", "num_nodes": 5, "num_edges": 3}
    ...
    def test_json_serialization(self):
        ...
        try:
            from networkx_mcp.utils.formatters import from_json, to_json
            ...
            try:
                from networkx_mcp.utils.formatters import deserialize, serialize
...
class TestFeatures:
    ...
    def test_is_feature_enabled(self):
        ...
        try:
            ...
            # Try alternative names
            try:
                from networkx_mcp.features import check_feature, is_enabled
    ...
    def test_get_feature_config(self):
        ...
        try:
            from networkx_mcp.features import FEATURE_CONFIG, get_feature_config
