...
class TestNodeOps:
    ...
    def test_add_node_operation(self):
        ...
        try:
            from networkx_mcp.core.node_ops import add_node, NodeOperations
...
class TestEdgeOps:
    ...
    def test_add_edge_operation(self):
        ...
        try:
            from networkx_mcp.core.edge_ops import add_edge, EdgeOperations
...
class TestVisualizationBase:
    ...
    def test_visualization_utilities(self):
        ...
        functions = [attr for attr in dir(base) if not attr.startswith('_') and callable(getattr(base, attr))]
