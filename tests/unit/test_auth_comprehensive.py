...
class TestAPIKeyManager(unittest.TestCase):
    ...
    def test_list_keys_with_data(self):
        ...
        key2 = self.manager.generate_key("user2", {"read", "write"})
    ...
    def test_rate_limiting(self):
        ...
        for i in range(5):
            assert self.manager.check_rate_limit(key, limit=10, window_minutes=60) is True
...
class TestAuthMiddleware(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.key_manager = APIKeyManager(storage_path=storage_path)
...
class TestAuthCLI(unittest.TestCase):
    ...
    @patch('sys.argv', ['auth.py', 'generate', 'admin_user', '--permissions', 'read', 'write', 'admin'])
    @patch('builtins.print')
