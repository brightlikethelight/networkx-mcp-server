...
class ErrorMetrics:
    ...
    total_errors: int = 0
    errors_by_type: Dict[GraphErrorType, int] = field(default_factory=lambda: defaultdict(int))
...
class ErrorHandler:
    ...
    async def recover(self, error: GraphError, context: Dict[str, Any]) -> Optional[Any]:
        """
    ...
    def detect_error_patterns(self) -> List[Tuple[GraphErrorType, int]]:
        ...
        patterns = [(error_type, count) for error_type, count in error_counts.items() if count > 3]
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recovery_rate": self.metrics.successful_recoveries / max(self.metrics.recovery_attempts, 1),
            "circuit_breakers": {
