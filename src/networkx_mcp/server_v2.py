...
class NetworkXMCPServer:
    ...
    def _register_core_tools(self):
        ...
        async def create_graph(
            graph_id: str, graph_type: str = "Graph", **kwargs
        ) -> str:
            """Create a new graph.
        ...
        async def shortest_path(
            graph_id: str, source: str, target: str, weight: str = None
        ) -> dict:
        ...
        async def visualize_graph(
            graph_id: str, backend: str = "matplotlib", layout: str = "spring", **kwargs
        ) -> str:
            """Visualize a graph.
