...
def test_mcp_tools():
    ...
    try:
        ...
        if hasattr(mcp, 'tools'):
            print(f"   ✅ MCP server object created successfully")
        else:
            print(f"   ⚠️ MCP server object may not be properly configured")
...
def test_visualization():
    ...
    try:
        ...
        try:
            ...
            print(f"   ✅ Plotly visualization: interactive plot created")
        except ImportError:
...
def show_usage_examples():
    ...
    print(f"📚 Read docs/API.md for full documentation")
...
async def main():
    ...
    print(f"   python -m networkx_mcp.server")
    print(f"\n📊 Run validation with:")
    print(f"   python validate_server.py")
